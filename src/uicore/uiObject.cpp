...
void uiObject::initUiSystem() {
    ...
    vertexes.push_back(Vertex{glm::vec3(-.5,-.5,.5),glm::vec2(0)});
    vertexes.push_back(Vertex{glm::vec3(.5,.5,.5),glm::vec2(1)});
    vertexes.push_back(Vertex{glm::vec3(.5,-.5,-.5),glm::vec2(1,0)});
    vertexes.push_back(Vertex{glm::vec3(-.5,.5,-.5),glm::vec2(0,1)});
...
void uiObject::render(glm::mat4& orthProj) {
    ...
    trans = glm::rotate(trans, .13f, glm::vec3(0,1,0));
